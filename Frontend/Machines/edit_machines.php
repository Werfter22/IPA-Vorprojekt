        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="vm_host" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="Host A">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="cpu" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="Intel i7">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="number" name="cores" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="8">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="number" name="ram_mb" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="16384">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="os" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="Windows 10">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="os_info" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="Version 21H2">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="location" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="Factory Floor 1">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="lowest_unit" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="Unit A">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="date" name="buy_date" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="2022-01-01">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="number" name="value_of_hardware" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="2000">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="number" name="restore_hours" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="5">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="serial_number" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="SN123456789">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="date" name="production_date" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="2021-06-15">
                </div>
            </div>
