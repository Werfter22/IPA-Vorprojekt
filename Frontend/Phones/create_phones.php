...
<div class="max-w-7xl mx-auto bg-white p-8 shadow-lg rounded-lg">
    ...
    <form id="createPhonesForm">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- Tel. Mobile 1 -->
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700">Tel. Mobile 1</label>
                    <input type="text" name="tel_mobile_1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>
            </div>
