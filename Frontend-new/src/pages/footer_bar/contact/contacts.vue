    ...
    <div class="container mx-auto mt-10 p-6 bg-white shadow-md rounded-lg">
      ...
      <div class="mb-4">
        ...
        <p class="text-gray-700">
          E-Mail: 
          <a href="mailto:sven.weidenmann@werft22.com" class="text-blue-500 hover:underline">
            sven.weidenmann@werft22.com
          </a>
        </p>
...
import Footer from '../footer/footer.vue'; // Adjust the path as necessary
</script>
