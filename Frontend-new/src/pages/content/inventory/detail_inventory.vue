        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="space-y-4">
            <div>
              ...
              <input type="text" v-model="name" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
            </div>
          </div>
...
const handleSubmit = () => {
  ...
  notificationMessage.value = "Inventar erfolgreich erstellt!";
